...
@Service
public class FileSystemStorageSericelmpl implements StorageService {
	...
	public FileSystemStorageSericelmpl(StorageProperties propertites) {
		this.rootLocation = Paths.get(propertites.getLocation());
	}
